...
class TestWebScraper(unittest.TestCase):
    ...
    def test_fetch_mii_table_into_json_object(self):
        ...
        json_mii_dict = json.loads(self.__WEBSCRAPER.get_mii_json_object())
    ...
    def test_get_issuing_networks(self):
        self.__WEBSCRAPER.fetch_iin_table_into_json_object()
        issuing_networks = self.__WEBSCRAPER.get_issuing_networks()
    ...
    def test_get_industry_identifiers(self):
        self.__WEBSCRAPER.fetch_mii_table_into_json_object()
        industry_identifiers = self.__WEBSCRAPER.get_industry_identifiers()
